...
namespace TaxiFareWithMLML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"D:\GitHub\TaxiFareWithML\taxi-fare-train.csv";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.Regression.Trainers.FastTree(new FastTreeRegressionTrainer.Options() { NumberOfLeaves = 46, MinimumExampleCountPerLeaf = 1, NumberOfTrees = 500, LearningRate = 0.1040929f, Shrinkage = 2.342347f, LabelColumnName = "fare_amount", FeatureColumnName = "Features" });
